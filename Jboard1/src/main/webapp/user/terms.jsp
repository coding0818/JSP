    ...
    <section class="terms">
        <table border="1">
            ...
            <tr>
                ...
                <label><input type="checkbox" for="checkbox" class="terms">&nbsp;동의합니다.</label>
                </td>
            </tr>
        </table>
        <table border="1">
            ...
            <tr>
                <td>
                <textarea name="terms"><%= tb.getPrivacy() %></textarea>
                <label><input type="checkbox" for="checkbox" class="privacy">&nbsp;동의합니다.</label>
                </td>
            </tr>
        </table>
        <p>
